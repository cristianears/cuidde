...
const hiringOptions = [
  ...
  },
  {
    ...
    description:
      "A icuide conecta famílias e profissionais. A forma de contratação — autônomo, MEI ou outro modelo — é definida diretamente entre as partes.",
  },
];
      ...
      <div className="container mx-auto px-6 md:px-10 relative">
        <div className="max-w-3xl mx-auto text-center mb-8">
          ...
          <p className="text-sm md:text-base text-muted-foreground">
            Seja para uma necessidade pontual ou um cuidado contínuo, a icuide facilita a conexão
