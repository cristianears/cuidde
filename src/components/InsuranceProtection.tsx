...
const stats = [
  ...
  },
  {
    ...
    detail: "Quando a necessidade surge, não há tempo para pesquisar. Quem já tem a Cuidde, já está pronto.",
  },
];
      ...
      <div className="container mx-auto px-6 md:px-10 relative">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            Encontrar um cuidador confiável no Brasil ainda é uma loteria. A Cuidde existe para mudar isso.
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto text-center bg-card rounded-3xl p-10 shadow-card border border-border/30">
          ...
          <p className="text-muted-foreground mb-8 leading-relaxed">
            Criar uma conta na Cuidde é gratuito. Quando você precisar, as informações que importam já estarão na sua
            mão.
          </p>
