...
describe('legal document links', () => {
  ...
  it('keeps footer navigation pointed at real landing sections', () => {
    ...
    expect(footer).toContain('Cidades atendidas')
    expect(footer).toContain('/cuidador-de-idosos-sao-jose-dos-campos/')
    expect(footer).toContain('/cuidador-de-idosos-jacarei/')
    expect(footer).toContain('/cuidador-de-idosos-vale-do-paraiba/')
    expect(footer).toContain('/cuidador-noturno-sao-jose-dos-campos/')
