...
- não seleciona, contrata, supervisiona, dirige, escala, remunera ou substitui Cuidadores em nome das Famílias;
- não participa do contrato, acordo, negociação ou relação de trabalho eventualmente formada entre Família e Cuidador;
- não garante disponibilidade, pontualidade, conduta, habilitação profissional, qualidade técnica, segurança, resultado, idoneidade ou adequação de qualquer Cuidador;
- não garante que documentos, referências, certificados, registros profissionais, declarações, fotos ou demais informações enviadas por usuários sejam verdadeiros, completos, atuais, autênticos ou suficientes para contratação.

Qualquer relação contratual, civil, trabalhista, consumerista, tributária, previdenciária, regulatória ou de prestação de serviços firmada fora ou dentro da plataforma será de responsabilidade exclusiva dos usuários envolvidos.
...
## 5. Cadastro e veracidade das informações
...
- usar documentos, fotos, certificados ou referências de terceiros sem autorização;
- omitir informações relevantes para segurança, contratação ou prestação dos serviços;
...
O Cuidador poderá anexar ou informar documentos, certificados, registros profissionais, referências, foto, biografia e outros materiais relacionados ao seu perfil.

O Cuidador declara e garante que:

- todos os documentos e informações enviados são legítimos, verdadeiros, atuais e pertencem ao próprio Cuidador;
- possui autorização para indicar referências profissionais e dados de terceiros;
- não enviará documento adulterado, falso, vencido, ilegível, incompleto ou pertencente a outra pessoa;
...
## 7. Responsabilidade das Famílias na escolha e contratação

A Família é exclusivamente responsável por avaliar se um Cuidador é adequado às suas necessidades antes de contratar ou permitir entrada em residência, hospital, clínica ou qualquer outro local.

Antes da contratação, recomenda-se que a Família:

- realize entrevista própria;
- confirme identidade, experiência, formação e referências;
- solicite documentos originais ou complementares quando necessário;
- verifique registros profissionais, certidões, antecedentes, recomendações e demais informações relevantes;
- formalize contrato, condições de pagamento, horários, atribuições, limites de atuação e regras de segurança;
- avalie riscos específicos do idoso, paciente, residência, saúde, mobilidade, medicamentos, equipamentos e rotina;
- consulte profissional habilitado quando houver demanda de enfermagem, saúde, administração de medicamentos, procedimentos invasivos ou cuidados especializados.

A decisão de contratar, manter, substituir ou dispensar um Cuidador é da Família.

## 8. Relação entre Família e Cuidador
...
- furtos, perdas, extravios, fraudes, agressões, negligência, imprudência, imperícia ou condutas ilícitas;
- obrigações trabalhistas, previdenciárias, fiscais, securitárias ou regulatórias;
...
Informações publicadas por Cuidadores ou Famílias não substituem orientação de médico, enfermeiro, fisioterapeuta, psicólogo, terapeuta ocupacional ou outro profissional habilitado.
...
Em contratações realizadas pela internet, o usuário consumidor poderá exercer o direito de arrependimento no prazo legal de 7 dias, contado da contratação, pelos canais de atendimento informados pela icuide. O cancelamento interrompe renovações futuras e, como regra operacional da plataforma, o acesso às funcionalidades pagas permanece disponível até o fim do período contratado.

Caso o usuário deseje solicitar reembolso, contestar uma cobrança ou tratar de uma hipótese legal específica, deverá entrar em contato pelos canais de atendimento da icuide, incluindo contato@icuide.com.br, para análise do pedido e orientação sobre o processamento pelo intermediador de pagamento quando aplicável.
...
É proibido usar a comunicação da plataforma para:

- praticar discriminação, assédio, ameaça, ofensa ou fraude;
- compartilhar conteúdo ilegal, falso, sensível ou de terceiros sem autorização;
- solicitar ou oferecer serviços ilícitos;
...
O envio de documentos, informações de saúde, referências, dados de idosos, dados de terceiros ou outros dados sensíveis exige autorização adequada, base legal aplicável e, quando necessário, consentimento específico e destacado.
...
- perda de acesso ao e-mail;
- golpes, engenharia social ou phishing;
- falhas de segurança causadas pelo próprio usuário.

O usuário deve comunicar imediatamente qualquer suspeita de uso indevido da conta.
...
- risco a usuários, idosos, pacientes, terceiros ou à plataforma;
- inadimplência;
- ordem judicial, solicitação de autoridade ou obrigação legal;
- uso abusivo, discriminatório, ilícito ou inseguro.

O usuário poderá solicitar encerramento da conta, observada a retenção de dados necessária para cumprimento legal, segurança, prevenção a fraude, auditoria, exercício regular de direitos e obrigações contratuais.
...
- uso indevido de dados pessoais ou documentos de terceiros;
- contratação ou prestação de serviços entre usuários;
- descumprimento de lei, obrigação profissional, trabalhista, fiscal, previdenciária, regulatória ou contratual;
- dano causado a idoso, paciente, familiar, Cuidador, terceiro ou patrimônio.
