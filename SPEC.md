...
- **`profile_complete`** — recalcula ao alterar perfil/referencias/documentos. Critérios: cidade+bairro + bio ≥10 chars + specialties[]. RG/CNH e referencias profissionais sao opcionais: contam como sinais de confianca, selo, filtro e ranking, mas nao podem bloquear visibilidade na busca.
